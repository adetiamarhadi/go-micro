...
func (app *Config) logItem(w http.ResponseWriter, r LogPayload) {
	jsonData, _ := json.MarshalIndent(r, "", "\t")

	log.Println("from broker:", string(jsonData))
...
func (app *Config) authenticate(w http.ResponseWriter, r AuthPayload) {
